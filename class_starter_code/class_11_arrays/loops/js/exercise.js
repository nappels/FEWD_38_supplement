 ...
 * Use an each loop to increase each value by 1 and store the value back in the array.
...
* Append each of these names to the class-list element using an each loop.
*/
